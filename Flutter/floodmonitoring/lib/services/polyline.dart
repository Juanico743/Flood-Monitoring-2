...
class PolylineService {
  ...
  static Map<String, double> _getBBox(LatLng center, double radiusMeters) {
    double deltaLat = radiusMeters / 111000; // approx degrees latitude
    double deltaLon = radiusMeters / (111000 * cos(center.latitude * 3.14159265359 / 180)); // longitude correction
